...
class MainRepository {
    ...
    suspend fun createOrder(studyRoomId: String, seatId: String, startTime: String, endTime: String, bookingType: String) =
    ...
    suspend fun getOrderDetail(id: String) = apiManager.getOrderDetail(id)
    suspend fun cancelOrder(id: String) = apiManager.cancelOrder(id)
    suspend fun payOrder(id: String) = apiManager.payOrder(id)
    suspend fun getReservationRules() = apiManager.getReservationRules()

    suspend fun checkin(reservationId: String, seatId: String) = apiManager.checkin(reservationId, seatId)
    suspend fun checkout(checkInRecordId: String) = apiManager.checkout(checkInRecordId)
    ...
    suspend fun createPayment(orderId: String, amount: Double, paymentMethod: String) =
        apiManager.createPayment(orderId, amount, paymentMethod)
    suspend fun getPaymentStatus(id: String) = apiManager.getPaymentStatus(id)
